...
public class CategoryTest {
    ...
    @Test
    public void givenAnInvalidNameLengthMoreThan255_whenCallNewCategoryAndValidade_thenShouldReceiveError() {
        final var expectedErrorCount = 1;
        final var expectedErrorMessage = "'name' must be between 3 and 255 characters";
        final var expectedName = """
    ...
    @Test
    public void givenAValidEmptyDescription_whenCallNewCategoryAndValidade_thenShouldReceiveOk() {
        final var expectedName = "Filmes";
    ...
    @Test
    public void givenAValidFalseIsActive_whenCallNewCategoryAndValidade_thenShouldReceiveOk() {
        final var expectedName = "Filmes";
        final var expectedDescription = "A categoria mais assistida";
    ...
    public void givenAValidCategory_whenCallUpdateWithInvalidParams_thenReturnCategoryUpdated() {
        ...
        final var expectedDescription = "A categoria mais assistida";
        final var expectedIsActive = true;
        final var aCategory = Category.newCategory("Filmes", "A categoria mais assistida", expectedIsActive);
        Assertions.assertDoesNotThrow(() -> aCategory.validate(new ThrowsValidationHandler()));
